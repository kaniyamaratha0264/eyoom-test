...
<div class="wrapper">
    ...
    <?php /*----- header 시작 -----*/ ?>
    <header class="header-wrap header-wrap-main <?php if(!defined('_INDEX_')) { ?>page-header-wrap<?php } ?>">
            ...
            <div class="container">
                <div class="row align-items-center position-relative">
                    ...
                    <div class="col-lg-9 clearfix d-none d-lg-block">
                        <div class="d-flex align-items-center ms-auto justify-content-end top-header-custom">
                        <ul class="top-header-nav list-unstyled thn-start">
                        <li class="margin-0"><a href="<?php echo G5_SHOP_URL; ?>/couponzone.php">쿠폰존</a></li>
                            ...
                            <div class="header-title-search d-none d-lg-block">
                                <form name="frmsearch1" action="<?php echo G5_SHOP_URL; ?>/search.php" onsubmit="return search_submit(this);" class="eyoom-form eyoom-form eyoom-form-new">
                                ...
                                <div class="input input-button mb-0">
                                    ...
                                    <div class="button"><input type="submit"><i class="fas"></i>
                                    <img src="<?php echo EYOOM_THEME_URL; ?>/image/search_new.svg" class="search_user" alt="<?php echo $config['cf_title']; ?>">
                                </div>
                                </div>
                                </form>
                            </div>
        ...
        <div class="nav-wrap nav-wrap-custom">
            <div class="container">
                    ...
                    <div class="sidebar-left offcanvas offcanvas-start" tabindex="-1" id="offcanvasLeft" aria-controls="offcanvasLeftLabel">
                        <div class="sidebar-left-content">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="dropdown dropdown-mega-menu d-none d-lg-block dropdown-mega-menu-main">
                                    ...
                                    <?php } ?>
                                        <li class="dropdown-submenu">
                                            <a href="<?php echo $menu_2['me_link']; ?>" target="_<?php echo $menu_2['me_target']; ?>" class="dropdown-item nav-link <?php if (isset($menu_2['active']) && $menu_2['active']) echo 'active';?>">
                                                ...
                                                <i class="fas fa-angle-rightt sub-caret hidden-sm hidden-xs">
                                                <img src="<?php echo EYOOM_THEME_URL; ?>/image/chevron-right.svg" alt="<?php echo $config['cf_title']; ?>">
