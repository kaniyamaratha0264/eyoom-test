                    ...
                    <div class="col-lg-9 clearfix d-none d-lg-block">
                        ...
                        <li class="margin-0">
                            ...
                            <div class="header-title-search d-none d-lg-block">
                                <form name="fsearchbox" method="get" action="<?php echo G5_BBS_URL; ?>/search.php" onsubmit="return fsearchbox_submit(this);" class="eyoom-form eyoom-form-new">
                                ...
                                <div class="input input-button mb-0">
                                    ...
                                    <div class="button"><input type="submit"><i class="fas fa"></i>
